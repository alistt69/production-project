...
describe('classes', () => {
  ...
  test('with mods', () => {
    ...
    expect(
      classNames('some_class', { hovered: true, scrollable: true }, ['class1', 'class2']),
    ).toBe(expected);
  });
  ...
  test('with mods false', () => {
    ...
    expect(
      classNames('some_class', { hovered: false, scrollable: true }, ['class1', 'class2']),
    ).toBe(expected);
  });
  ...
  test('with mods undefined', () => {
    ...
    expect(
      classNames('some_class', { hovered: true, scrollable: undefined }, ['class1', 'class2']),
    ).toBe(expected);
  });
});
